...
{
    [Authorize]
    public class ManageTeachingServicesController : Controller
    {
        private readonly IUserService _userService;
        private readonly ApplicationDbContext _contexto;

        public ManageTeachingServicesController(IUserService userService, ApplicationDbContext contexto)
        {
